...
def test_d3(proj_path):
    ...
    npt.assert_almost_equal(d3.atoms[0].get_forces(), [[0.0, 0.0, 9.5722440e-05], [0.0, -4.0598028e-05, -4.7861220e-05], [0.0, 4.0598028e-05, -4.7861220e-05]])
...
def test_d3_existing_calc(proj_path):
    ...
    assert lj.atoms[0].get_potential_energy() - d3.atoms[0].get_potential_energy() == pytest.approx(0.00978192157)
